...
!function(e, t) {
    ...
    function y(e, t, n, r) {
        ...
        , u = s(), l = n && n[3] || (Ee.cssNumber[t] ? "" : "px"), c = e.nodeType && (Ee.cssNumber[t] || "px" !== l && +u) && Ye.exec(Ee.css(e, t));
        if (c && c[3] !== l) {
            for (u /= 2,
            l = l || c[3],
            c = +u || 1; a--; )
    ...
    function x(e, t) {
        for (var n, r, o = [], i = 0, a = e.length; a > i; i++)
            ...
            o[i] || (r.style.display = "")),
            "" === r.style.display && Je(r) && (o[i] = b(r))) : "none" !== n && (o[i] = "none",
            ze.set(r, "display", n)));
        for (i = 0; a > i; i++)
    ...
    function P(e, t, r, o) {
        t = fe.apply([], t);
        var i, a, s, u, l, c, f = 0, d = e.length, p = d - 1, h = t[0], m = xe(h);
        ...
        if (d && (i = T(t, e[0].ownerDocument, !1, e, o),
        a = i.firstChild,
        1 === i.childNodes.length && (i = a),
        a || o)) {
            for (s = Ee.map(w(i, "script"), L),
            u = s.length; d > f; f++)
                l = i,
            ...
            if (u)
                ...
                f = 0; u > f; f++)
                    l = s[f],
                    ot.test(l.type || "") && !ze.access(l, "globalEval") && Ee.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? Ee._evalUrl && !l.noModule && Ee._evalUrl(l.src, {
    ...
    function q(e, t, n) {
        for (var r, o = t ? Ee.filter(t, e) : e, i = 0; null != (r = o[i]); i++)
            ...
            r.parentNode && (n && Ke(r) && C(w(r, "script")),
    ...
    function M(e, t, n) {
        ...
        !be.pixelBoxStyles() && ht.test(a) && gt.test(t) && (r = s.width,
        o = s.minWidth,
        i = s.maxWidth,
    ...
    function F(e, t, n, r, o, i) {
        ...
        for (; 4 > a; a += 2)
            ...
            r ? ("content" === n && (u -= Ee.css(e, "padding" + Ve[a], !0, o)),
            "margin" !== n && (u -= Ee.css(e, "border" + Ve[a] + "Width", !0, o))) : (u += Ee.css(e, "padding" + Ve[a], !0, o),
            "padding" !== n ? u += Ee.css(e, "border" + Ve[a] + "Width", !0, o) : s += Ee.css(e, "border" + Ve[a] + "Width", !0, o));
    ...
    function z(e, t, n) {
        ...
        return (!be.boxSizingReliable() && i || "auto" === s || !parseFloat(s) && "inline" === Ee.css(e, "display", !1, r)) && e.getClientRects().length && (i = "border-box" === Ee.css(e, "boxSizing", !1, r),
        a = u in e,
        a && (s = e[u])),
        s = parseFloat(s) || 0,
    ...
    function U() {
        St && (ue.hidden === !1 && e.requestAnimationFrame ? e.requestAnimationFrame(U) : e.setTimeout(U, Ee.fx.interval),
        Ee.fx.tick())
    }
    function X() {
    ...
    function V(e, t, n) {
        var r, o, i, a, s, u, l, c, f = "width"in t || "height"in t, d = this, p = {}, h = e.style, m = e.nodeType && Je(e), g = ze.get(e, "fxshow");
        ...
        u || !Ee.isEmptyObject(p)) {
            ...
            u = !1;
            for (r in p)
                u || (g ? "hidden"in g && (m = g.hidden) : g = ze.access(e, "fxshow", {
                    display: l
                }),
                i && (g.hidden = !m),
                m && x([e], !0),
    ...
    function K(e, t, n) {
        var r, o, i = 0, a = K.prefilters.length, s = Ee.Deferred().always(function() {
            delete u.elem
        }), u = function() {
            if (o)
                return !1;
            for (var t = Et || X(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, i = 1 - r, a = 0, u = l.tweens.length; u > a; a++)
                l.tweens[a].run(i);
            return s.notifyWith(e, [l, i, n]),
            1 > i && u ? n : (u || s.notifyWith(e, [l, 1, 0]),
            s.resolveWith(e, [l]),
            !1)
        }, l = s.promise({
            elem: e,
    ...
    Ee.extend = Ee.fn.extend = function() {
        ...
        s--); u > s; s++)
            if (null != (e = arguments[s]))
                for (t in e)
                    r = e[t],
                    "__proto__" !== t && a !== r && (l && r && (Ee.isPlainObject(r) || (o = Array.isArray(r))) ? (n = a[t],
                    i = o && !Array.isArray(n) ? [] : o || Ee.isPlainObject(n) ? n : {},
                    o = !1,
                    a[t] = Ee.extend(l, i, r)) : void 0 !== r && (a[t] = r));
        return a
    }
    ,
    Ee.extend({
        ...
        isPlainObject: function(e) {
            var t, n;
            return e && "[object Object]" === me.call(e) ? (t = le(e)) ? (n = ge.call(t, "constructor") && t.constructor,
    ...
    var ke = function(e) {
        function t(e, t, n, r) {
            ...
            "string" != typeof e || !e || 1 !== h && 9 !== h && 11 !== h)
                return n;
            if (!r && ((t ? t.ownerDocument || t : $) !== O && D(t),
            t = t || O,
            P)) {
                if (11 !== h && (u = be.exec(e)))
                    if (o = u[1]) {
                ...
                if (C.qsa && !Q[e + " "] && (!q || !q.test(e)) && (1 !== h || "object" !== t.nodeName.toLowerCase())) {
                    ...
                    d = t,
                    1 === h && fe.test(e)) {
                        for ((s = t.getAttribute("id")) ? s = s.replace(Te, Ee) : t.setAttribute("id", s = B),
                        l = k(e),
                        i = l.length; i--; )
                            l[i] = "#" + s + " " + p(l[i]);
                        c = l.join(","),
        ...
        function y(e, t, n, o, i, a) {
            ...
            i && !i[B] && (i = y(i, a)),
            r(function(r, a, s, u) {
                var l, c, f, d = [], p = [], h = a.length, m = r || g(t || "*", s.nodeType ? [s] : s, []), y = !e || !r && t ? m : v(m, d, e, s, u), b = n ? i || (r ? e : h || o) ? [] : a : y;
                if (n && n(y, b, s, u),
                o)
                    for (l = v(b, p),
                    o(l, [], s, u),
        ...
        function x(e, n) {
            var o = n.length > 0
              ...
              , a = function(r, a, s, u, l) {
                var c, f, d, p = 0, h = "0", m = r && [], g = [], y = j, b = r || i && T.find.TAG("*", l), x = F += null == y ? 1 : Math.random() || .1, w = b.length;
                for (l && (j = a === O || a || l); h !== w && null != (c = b[h]); h++) {
                    if (i && c) {
                        for (f = 0,
                        a || c.ownerDocument === O || (D(c),
                        s = !P); d = e[f++]; )
                            if (d(c, a || O, s)) {
                                u.push(c);
                                break
        ...
        var w, C, T, E, S, k, A, N, j, I, L, D, O, H, P, q, M, _, R, B = "sizzle" + 1 * new Date, $ = e.document, F = 0, z = 0, W = n(), U = n(), X = n(), Q = n(), Y = function(e, t) {
            return e === t && (L = !0),
            0
        }, V = {}.hasOwnProperty, G = [], K = G.pop, Z = G.push, J = G.push, ee = G.slice, te = function(e, t) {
            for (var n = 0, r = e.length; r > n; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, ne = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", re = "[\\x20\\t\\r\\n\\f]", oe = "(?:\\\\.|[\\w-]|[^\x00-\\xa0])+", ie = "\\[" + re + "*(" + oe + ")(?:" + re + "*([*^$|!~]?=)" + re + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + oe + "))|)" + re + "*\\]", ae = ":(" + oe + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + ie + ")*)|.*)\\)|)", se = new RegExp(re + "+","g"), ue = new RegExp("^" + re + "+|((?:^|[^\\\\])(?:\\\\.)*)" + re + "+$","g"), le = new RegExp("^" + re + "*," + re + "*"), ce = new RegExp("^" + re + "*([>+~]|" + re + ")" + re + "*"), fe = new RegExp(re + "|>"), de = new RegExp(ae), pe = new RegExp("^" + oe + "$"), he = {
            ID: new RegExp("^#(" + oe + ")"),
            CLASS: new RegExp("^\\.(" + oe + ")"),
            TAG: new RegExp("^(" + oe + "|[*])"),
            ATTR: new RegExp("^" + ie),
        ...
        }, me = /HTML$/i, ge = /^(?:input|select|textarea|button)$/i, ve = /^h\d$/i, ye = /^[^{]+\{\s*\[native \w/, be = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, xe = /[+~]/, we = new RegExp("\\\\([\\da-f]{1,6}" + re + "?|(" + re + ")|.)","ig"), Ce = function(e, t, n) {
            var r = "0x" + t - 65536;
            return r !== r || n ? t : 0 > r ? String.fromCharCode(r + 65536) : String.fromCharCode(r >> 10 | 55296, 1023 & r | 56320)
        }, Te = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, Ee = function(e, t) {
        ...
        D = t.setDocument = function(e) {
            ...
            H = O.documentElement,
            P = !S(O),
            $ !== O && (n = O.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Se, !1) : n.attachEvent && n.attachEvent("onunload", Se)),
            ...
            M = [],
            q = [],
            (C.qsa = ye.test(O.querySelectorAll)) && (o(function(e) {
                H.appendChild(e).innerHTML = "<a id='" + B + "'></a><select id='" + B + "-\r\\' msallowcapture=''><option selected=''></option></select>",
                e.querySelectorAll("[msallowcapture^='']").length && q.push("[*^$]=" + re + "*(?:''|\"\")"),
                e.querySelectorAll("[selected]").length || q.push("\\[" + re + "*(?:value|" + ne + ")"),
            ...
            R = t || ye.test(H.contains) ? function(e, t) {
            ...
            Y = t ? function(e, t) {
                ...
                1 & n || !C.sortDetached && t.compareDocumentPosition(e) === n ? e === O || e.ownerDocument === $ && R($, e) ? -1 : t === O || t.ownerDocument === $ && R($, t) ? 1 : I ? te(I, e) - te(I, t) : 0 : 4 & n ? -1 : 1)
            }
            : function(e, t) {
                if (e === t)
                    return L = !0,
                ...
                if (!o || !i)
                    return e === O ? -1 : t === O ? 1 : o ? -1 : i ? 1 : I ? te(I, e) - te(I, t) : 0;
                if (o === i)
                    return a(e, t);
        ...
        T = t.selectors = {
            ...
            filter: {
                ...
                CHILD: function(e, t, n, r, o) {
                    ...
                    : function(t, n, u) {
                        var l, c, f, d, p, h, m = i !== a ? "nextSibling" : "previousSibling", g = t.parentNode, v = s && t.nodeName.toLowerCase(), y = !u && !s, b = !1;
                        if (g) {
                            if (i) {
                                for (; m; ) {
                                    for (d = t; d = d[m]; )
                            ...
                            b = p),
                            b === !1)
                                for (; (d = ++p && d && d[m] || (b = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++b || (y && (f = d[B] || (d[B] = {}),
                                c = f[d.uniqueID] || (f[d.uniqueID] = {}),
                                c[e] = [F, b]),
                                d !== t)); )
                                    ;
        ...
        N = t.select = function(e, t, n, r) {
            ...
            1 === c.length) {
                ...
                i.length > 2 && "ID" === (a = i[0]).type && 9 === t.nodeType && P && T.relative[i[1].type]) {
                    if (t = (T.find.ID(a.matches[0].replace(we, Ce), t) || [])[0],
                    !t)
                        return n;
                    l && (t = t.parentNode),
            ...
            return (l || A(e, c))(r, t, !P, n, !t || xe.test(e) && f(t.parentNode) || t),
            n
        }
        ,
    ...
    var Le, De = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, Oe = Ee.fn.init = function(e, t, n) {
        var r, o;
        if (!e)
            return this;
        if (n = n || Le,
        "string" == typeof e) {
            ...
            return o = ue.getElementById(r[2]),
            o && (this[0] = o,
            this.length = 1),
            this
        }
    ...
    Ee.each({
        ...
        contents: function(e) {
            return "undefined" != typeof e.contentDocument ? e.contentDocument : (i(e, "template") && (e = e.content || e),
        ...
        Ee.fn[e] = function(n, r) {
            ...
            this.length > 1 && (Pe[e] || Ee.uniqueSort(o),
            He.test(e) && o.reverse()),
            this.pushStack(o)
        }
    });
    ...
    Ee.extend({
                            ...
                            var s = this
                              ...
                              , f = function() {
                                ...
                                if (!(a > t)) {
                                    ...
                                    xe(f) ? o ? f.call(e, i(a, n, l, o), i(a, n, c, o)) : (a++,
        ...
        when: function(e) {
            ...
            if (1 >= t && (f(e, i.done(a(n)).resolve, i.reject, !t),
    ...
    "complete" === ue.readyState || "loading" !== ue.readyState && !ue.documentElement.doScroll ? e.setTimeout(Ee.ready) : (ue.addEventListener("DOMContentLoaded", d),
    ...
    Ee.fn.extend({
        ...
        promise: function(e, t) {
            var n, r = 1, o = Ee.Deferred(), i = this, a = this.length, s = function() {
                --r || o.resolveWith(i, [i])
            };
    ...
    Ee.event = {
            ...
            if (g && (u = g.events)) {
                ...
                l = t.length; l--; )
                    ...
                    p) {
                        ...
                        a && !d.length && (f.teardown && f.teardown.call(e, h, g.handle) !== !1 || Ee.removeEvent(e, p, g.handle),
                        delete u[p])
                    } else
                        for (p in u)
        ...
        dispatch: function(e) {
            var t, n, r, o, i, a, s = Ee.event.fix(e), u = new Array(arguments.length), l = (ze.get(this, "events") || {})[s.type] || [], c = Ee.event.special[s.type] || {};
            for (u[0] = s,
            t = 1; t < arguments.length; t++)
                u[t] = arguments[t];
            if (s.delegateTarget = this,
            !c.preDispatch || c.preDispatch.call(this, s) !== !1) {
                for (a = Ee.event.handlers.call(this, s, l),
                ...
                for (; l !== this; l = l.parentNode || this)
                    if (1 === l.nodeType && ("click" !== e.type || l.disabled !== !0)) {
                        ...
                        n = 0; u > n; n++)
                            r = t[n],
                            o = r.selector + " ",
                            void 0 === a[o] && (a[o] = r.needsContext ? Ee(o, this).index(l) > -1 : Ee.find(o, this, null, [l]).length),
                            a[o] && i.push(r);
                        i.length && s.push({
                            elem: l,
                            handlers: i
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return nt.test(t.type) && t.click && i(t, "input") && j(t, "click", E),
                    !1
                },
                trigger: function(e) {
                    var t = this || e;
                    return nt.test(t.type) && t.click && i(t, "input") && j(t, "click"),
                    !0
                },
                _default: function(e) {
                    var t = e.target;
    ...
    Ee.each({
        ...
        Ee.event.special[e] = {
            ...
            handle: function(e) {
                ...
                return o && (o === r || Ee.contains(r, o)) || (e.type = i.origType,
    ...
    !function() {
        ...
        var r, o, i, a, s, u = ue.createElement("div"), l = ue.createElement("div");
    ...
    Ee.each(["height", "width"], function(e, t) {
        Ee.cssHooks[t] = {
            ...
            set: function(e, n, r) {
                var o, i = mt(e), a = !be.scrollboxSize() && "absolute" === i.position, s = a || r, u = s && "border-box" === Ee.css(e, "boxSizing", !1, i), l = r ? F(e, t, r, u, i) : 0;
                return u && a && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(i[t]) - F(e, t, "border", !1, i) - .5)),
    ...
    Ee.fx.step = {};
    var Et, St, kt = /^(?:toggle|show|hide)$/, At = /queueHooks$/;
    Ee.Animation = Ee.extend(K, {
        tweeners: {
            "*": [function(e, t) {
                var n = this.createTween(e, t);
                return y(n.elem, e, Ye.exec(t), n),
                n
            }
            ]
        },
    ...
    Ee.fn.extend({
        ...
        finish: function(e) {
            return e !== !1 && (e = e || "fx"),
            this.each(function() {
                var t, n = ze.get(this), r = n[e + "queue"], o = n[e + "queueHooks"], i = Ee.timers, a = r ? r.length : 0;
                for (n.finish = !0,
                Ee.queue(this, e, []),
    ...
    Ee.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== i && 8 !== i && 2 !== i)
                return "undefined" == typeof e.getAttribute ? Ee.prop(e, t, n) : (1 === i && Ee.isXMLDoc(e) || (o = Ee.attrHooks[t.toLowerCase()] || (Ee.expr.match.bool.test(t) ? Nt : void 0)),
                void 0 !== n ? null === n ? void Ee.removeAttr(e, t) : o && "set"in o && void 0 !== (r = o.set(e, n, t)) ? r : (e.setAttribute(t, n + ""),
                n) : o && "get"in o && null !== (r = o.get(e, t)) ? r : (r = Ee.find.attr(e, t),
                null == r ? void 0 : r))
        },
        attrHooks: {
            type: {
    ...
    Ee.extend({
        prop: function(e, t, n) {
            var r, o, i = e.nodeType;
            if (3 !== i && 8 !== i && 2 !== i)
                return 1 === i && Ee.isXMLDoc(e) || (t = Ee.propFix[t] || t,
                o = Ee.propHooks[t]),
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && r ? t ? this.addClass(e) : this.removeClass(e) : xe(e) ? this.each(function(n) {
                ...
                if (r)
                    ...
                    this.setAttribute && this.setAttribute("class", t || e === !1 ? "" : ze.get(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
            var t, n, r = 0;
            ...
            var t, n, r, o = this[0];
            {
                if (arguments.length)
                    ...
                    this.each(function(n) {
                        var o;
                        1 === this.nodeType && (o = r ? e.call(this, n, Ee(this).val()) : e,
            ...
            select: {
                ...
                set: function(e, t) {
                    for (var n, r, o = e.options, i = Ee.makeArray(t), a = o.length; a--; )
                        r = o[a],
                        (r.selected = Ee.inArray(Ee.valHooks.option.get(r), i) > -1) && (n = !0);
    ...
    Ee.extend(Ee.event, {
        trigger: function(t, n, r, o) {
            var i, a, s, u, l, c, f, d, p = [r || ue], h = ge.call(t, "type") ? t.type : t, m = ge.call(t, "namespace") ? t.namespace.split(".") : [];
            if (a = d = s = r = r || ue,
            3 !== r.nodeType && 8 !== r.nodeType && !Ot.test(h + Ee.event.triggered) && (h.indexOf(".") > -1 && (m = h.split("."),
            h = m.shift(),
            m.sort()),
            l = h.indexOf(":") < 0 && "on" + h,
            ...
            o || !f.trigger || f.trigger.apply(r, n) !== !1)) {
                if (!o && !f.noBubble && !we(r)) {
                    ...
                    Ot.test(u + h) || (a = a.parentNode); a; a = a.parentNode)
                        p.push(a),
                        s = a;
                ...
                return t.type = h,
                o || t.isDefaultPrevented() || f._default && f._default.apply(p.pop(), n) !== !1 || !Fe(r) || l && xe(r[h]) && !we(r) && (s = r[l],
                s && (r[l] = null),
    ...
    Ee.extend({
        ...
        ajax: function(t, n) {
            function r(t, n, r, s) {
                ...
                r && (x = ie(h, T, r)),
                x = ae(h, x, T, l),
                l ? (h.ifModified && (w = T.getResponseHeader("Last-Modified"),
            ...
            t = void 0),
            n = n || {};
            var o, i, a, s, u, l, c, f, d, p, h = Ee.ajaxSetup({}, n), m = h.context || h, g = h.context && (m.nodeType || m.jquery) ? Ee(m) : Ee.event, v = Ee.Deferred(), y = Ee.Callbacks("once memory"), b = h.statusCode || {}, x = {}, w = {}, C = "canceled", T = {
                readyState: 0,
            ...
            delete h.data),
            h.cache === !1 && (i = i.replace(Wt, "$1"),
            p = (Mt.test(i) ? "&" : "?") + "_=" + qt++ + p),
            h.url = i + p),
            h.ifModified && (Ee.lastModified[i] && T.setRequestHeader("If-Modified-Since", Ee.lastModified[i]),
            ...
            T.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Kt + "; q=0.01" : "") : h.accepts["*"]);
            for (d in h.headers)
    ...
    Ee.ajaxPrefilter("json jsonp", function(t, n, r) {
        ...
        return s || "jsonp" === t.dataTypes[0] ? (o = t.jsonpCallback = xe(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
        s ? t[s] = t[s].replace(nn, "$1" + o) : t.jsonp !== !1 && (t.url += (Mt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o),
        t.converters["script json"] = function() {
            return a || Ee.error(o + " was not called"),
            a[0]
        }
        ,
        t.dataTypes[0] = "json",
    ...
    Ee.offset = {
        setOffset: function(e, t, n) {
            var r, o, i, a, s, u, l, c = Ee.css(e, "position"), f = Ee(e), d = {};
            ...
            if (this[0]) {
                ...
                if ("fixed" === Ee.css(r, "position"))
                    ...
                    e = r.offsetParent || n.documentElement; e && (e === n.body || e === n.documentElement) && "static" === Ee.css(e, "position"); )
                        e = e.parentNode;
                    e && e !== r && 1 === e.nodeType && (o = Ee(e).offset(),
    ...
    Ee.each({
        ...
        Ee.fn[e] = function(r) {
            return Re(this, function(e, r, o) {
                var i;
                return we(e) ? i = e : 9 === e.nodeType && (i = e.defaultView),
    ...
    Ee.each(["top", "left"], function(e, t) {
        Ee.cssHooks[t] = _(be.pixelPosition, function(e, n) {
            return n ? (n = M(e, t),
            ht.test(n) ? Ee(e).position()[t] + "px" : n) : void 0
        })
    }),
    Ee.each({
        Height: "height",
        ...
        Ee.each({
            ...
            Ee.fn[r] = function(o, i) {
                ...
                return Re(this, function(t, n, o) {
                    var i;
                    return we(t) ? 0 === r.indexOf("outer") ? t["inner" + e] : t.document.documentElement["client" + e] : 9 === t.nodeType ? (i = t.documentElement,
                    Math.max(t.body["scroll" + e], i["scroll" + e], t.body["offset" + e], i["offset" + e], i["client" + e])) : void 0 === o ? Ee.css(t, n, s) : Ee.style(t, n, o, s)
                }, t, a ? o : void 0, a)
            }
        })
    }),
...
$(function() {
    function e() {
        ...
        l = n.children().length,
        c = s[l - 1],
        c > u ? (n.children().last().prependTo(r),
        l -= 1,
        e()) : u > s[l] && (r.children().first().appendTo(n),
        l += 1,
        e()),
        t.attr("count", o - l),
...
function(e) {
    ...
    var t, n, r, o, i, a, s = "Close", u = "BeforeClose", l = "AfterClose", c = "BeforeAppend", f = "MarkupParse", d = "Open", p = "Change", h = "mfp", m = "." + h, g = "mfp-ready", v = "mfp-removing", y = "mfp-prevent-close", b = function() {}, x = !!window.jQuery, w = e(window), C = function(e, n) {
        t.ev.on(h + e + m, n)
    }, T = function(t, n, r, o) {
    ...
    b.prototype = {
        ...
        open: function(n) {
            ...
            i += " mfp-close-btn-in") : t.wrap.append(S())),
        ...
        updateItemHTML: function() {
            ...
            var r = n.type;
            if (E("BeforeChange", [t.currItem ? t.currItem.type : "", r]),
            t.currItem = n,
            !t.currTemplate[r]) {
        ...
        addGroup: function(e, n) {
            ...
            n.mainEl = e,
            n.items ? (n.isObj = !0,
            e.off(o).on(o, r)) : (n.isObj = !1,
            n.delegate ? e.off(o).on(o, n.delegate, r) : (n.items = e,
            e.off(o).on(o, r)))
        },
    ...
    e.fn.magnificPopup = function(n) {
        ...
        if ("string" == typeof n)
            if ("open" === n) {
                var o, i = x ? r.data("magnificPopup") : r[0].magnificPopup, a = parseInt(arguments[1], 10) || 0;
                i.items ? o = i.items[a] : (o = r,
    ...
    ;
    var N, j, I, L = "inline", D = function() {
        I && (j.after(I.addClass(N)).detach(),
        I = null)
    };
                ...
                var n = 0
                  ...
                  , o = function(i) {
                    ...
                    M = setInterval(function() {
                        return r.naturalWidth > 0 ? void t._onImageHasSize(e) : (n > 200 && clearInterval(M),
                        n++,
            ...
            getImage: function(n, r) {
                var o = 0
                  , i = function() {
                    ...
                    n.hasSize = !0,
                    n.loaded = !0,
                    E("ImageLoadComplete")) : (o++,
                    200 > o ? setTimeout(i, 100) : a()))
                }
                  , a = function() {
        ...
        proto: {
            initZoom: function() {
                ...
                if (n.enabled && t.supportsTransition) {
                    var o, i, a = n.duration, l = function(e) {
                        var t = e.clone().removeAttr("style").removeAttr("class").addClass("mfp-animated-image")
                          ...
                          , i = "transition";
                        return o["-webkit-" + i] = o["-moz-" + i] = o["-o-" + i] = o[i] = r,
                        t.css(o),
                        t
                    }, c = function() {
    ...
    e.magnificPopup.registerModule($, {
        ...
        proto: {
            ...
            getIframe: function(n, r) {
                ...
                var a = {};
                return i.srcAction && (a[i.srcAction] = o),
...
function(e, t) {
    ...
    var t = {
      ...
      , s = function(e, t) {
        ...
        "easeInOutQuad" === e.easing && (n = .5 > t ? 2 * t * t : -1 + (4 - 2 * t) * t),
        "easeInCubic" === e.easing && (n = t * t * t),
        "easeOutCubic" === e.easing && (n = --t * t * t + 1),
        "easeInOutCubic" === e.easing && (n = .5 > t ? 4 * t * t * t : (t - 1) * (2 * t - 2) * (2 * t - 2) + 1),
        "easeInQuart" === e.easing && (n = t * t * t * t),
        "easeOutQuart" === e.easing && (n = 1 - --t * t * t * t),
        "easeInOutQuart" === e.easing && (n = .5 > t ? 8 * t * t * t * t : 1 - 8 * --t * t * t * t),
        "easeInQuint" === e.easing && (n = t * t * t * t * t),
        "easeOutQuint" === e.easing && (n = 1 + --t * t * t * t * t),
        "easeInOutQuint" === e.easing && (n = .5 > t ? 16 * t * t * t * t * t : 1 + 16 * --t * t * t * t * t),
      ...
      , l = function(t, n, r, o) {
        ...
        if (t.offsetParent)
            do
                i += t.offsetTop,
                t = t.offsetParent;
            while (t);return i = Math.max(i - n - r, 0),
      ...
      , g = function(i, g) {
        ...
        T.animateScroll = function(n, i, a) {
            ...
            if (g || y) {
                ...
                var w, E, S, k = c(x), A = g ? n : l(y, k, parseInt("function" == typeof d.offset ? d.offset(n, i) : d.offset, 10), d.clip), N = A - b, j = u(), I = 0, L = f(N, d), D = function(t, r) {
                    var o = e.pageYOffset;
                    return t == r || o == r || (r > b && e.innerHeight + o) >= j ? (T.cancelScroll(!0),
                    h(n, r, g),
                    m("scrollStop", d, n, i),
                    w = null,
                    C = null,
                    ...
                    D(S, A) || (C = e.requestAnimationFrame(O),
                    w = t)
                };
                if (0 === e.pageYOffset && e.scrollTo(0, 0),
                p(n, g, d),
                o())
        ...
        ;
        var E = function(t) {
            if (!t.defaultPrevented && !(0 !== t.button || t.metaKey || t.ctrlKey || t.shiftKey) && "closest"in t.target && (b = t.target.closest(i),
            b && "a" === b.tagName.toLowerCase() && !t.target.closest(v.ignore) && b.hostname === e.location.hostname && b.pathname === e.location.pathname && /#/.test(b.href))) {
                var n;
                try {
        ...
        T.destroy = function() {
            v && (document.removeEventListener("click", E, !1),
    ...
    var t = {
      ...
      , d = function(e, t) {
        if (t.nested) {
            ...
            n && (n.classList.remove(t.nestedClass),
            d(n, t))
        }
    }
      , p = function(e, t) {
      ...
      , h = function(e, t) {
        if (t.nested) {
            var n = e.parentNode.closest("li");
            n && (n.classList.add(t.nestedClass),
            h(n, t))
        }
    }
      , m = function(e, t) {
      ...
      , g = function(r, o) {
        ...
        d.detect = function() {
            var e = f(s, c);
            return e ? void (u && e.content === u.content || (p(u, c),
            m(e, c),
            u = e)) : void (u && (p(u, c),
            u = null))
        }
...
$(document).ready(function() {
    ...
    $(".page__content").find("h1, h2, h3, h4, h5, h6").each(function() {
        ...
        if (e) {
            ...
            t.href = "#" + e,
            t.innerHTML = '<span class="sr-only">Permalink</span><i class="fa fa-link"></i>',
            t.title = "Permalink",
            $(this).append(t)
        }
    })
